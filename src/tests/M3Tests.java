...
public class M3Tests {
	...
	@Test(timeout = 1000)
	public void testConstructorBuildingAlreadyCollapsedException1() throws Exception {
		Class[] inputs = { Disaster.class };
		testConstructorExists(Class.forName(buildingAlreadyCollapsedExceptionPath), inputs);
	}

	@Test(timeout = 1000)
	public void testConstructorBuildingAlreadyCollapsedException2() throws Exception {
		Class[] inputs = { Disaster.class, String.class };
		testConstructorExists(Class.forName(buildingAlreadyCollapsedExceptionPath), inputs);
	}
	...
	public void testConstructorCitizenAlreadyDeadException1() throws Exception {
		Class[] inputs = { Disaster.class, String.class };
		testConstructorExists(Class.forName(citizenAlreadyDeadExceptionPath), inputs);
	}
	...
	public void testConstructorIncompatibleTargetException1() throws Exception {
		Class[] inputs = { Unit.class, Rescuable.class };
		testConstructorExists(Class.forName(incompatibleTargetExceptionPath), inputs);
	}
	...
	public void testClassIsSubclassSimulationException() throws Exception {
		testClassIsSubclass(Class.forName(simulationExceptionPath), Exception.class);
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassDisasterException() throws Exception {
		testClassIsSubclass(Class.forName(disasterExceptionPath), Class.forName(simulationExceptionPath));
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassBuildingAlreadyCollapsedException() throws Exception {
		testClassIsSubclass(Class.forName(buildingAlreadyCollapsedExceptionPath), Class.forName(disasterExceptionPath));
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassCitizenAlreadyDeadException() throws Exception {
		testClassIsSubclass(Class.forName(citizenAlreadyDeadExceptionPath), Class.forName(disasterExceptionPath));
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassUnitException() throws Exception {
		testClassIsSubclass(Class.forName(unitExceptionPath), Class.forName(simulationExceptionPath));
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassAlreadySafeException() throws Exception {
		testClassIsSubclass(Class.forName(cannotTreatExceptionPath), Class.forName(unitExceptionPath));
	}

	@Test(timeout = 1000)
	public void testClassIsSubclassIncompatibleTargetException() throws Exception {
		testClassIsSubclass(Class.forName(incompatibleTargetExceptionPath), Class.forName(unitExceptionPath));
	}
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testAmbulanceRespondtoSafeCitizenWithInfectionException() throws Exception {
	...
	@Test(timeout = 3000)
	public void testAmbulanceRespondtoCorrectCitizenExceptionNotThrown() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address ambulanceAddress = getAddressFromWorld(s, 3, 9);
		Address citizenAddress = getAddressFromWorld(s, 3, 4);
	...
	public void testAmbulanceRespondtoResidentialBuildingException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address ambulanceAddress = getAddressFromWorld(s, 3, 9);
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testDiseaseControlUnitRespondtoSafeCitizenException() throws Exception {
		Simulator s = new Simulator(sos);
		Address diseaseControlUnitAddress = getAddressFromWorld(s, 3, 9);
		Address citizenAddress = getAddressFromWorld(s, 3, 4);

		Citizen c = new Citizen(citizenAddress, "1", "citizen1", 20, s);
		DiseaseControlUnit a = new DiseaseControlUnit("DiseaseControlUnit1", diseaseControlUnitAddress, 4, s);
		a.respond(c);
	}

	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testDiseaseControlUnitRespondtoSafeCitizenWithInjuryException() throws Exception {
		CommandCenter cc = new CommandCenter();
		Simulator s = new Simulator(cc);
		Address diseaseControlUnitAddress = getAddressFromWorld(s, 3, 9);
		Address citizenAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000)
	public void testDiseaseControlUnitRespondtoCorrectCitizenExceptionNotThrown() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address diseaseControlUnitAddress = getAddressFromWorld(s, 3, 9);
		Address citizenAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000, expected = IncompatibleTargetException.class)
	public void testDiseaseControlUnitRespondtoResidentialBuildingException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address diseaseControlUnitAddress = getAddressFromWorld(s, 3, 9);
		Address buildingAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testFireTruckRespondtoSafeResidentialBuildingException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
	...
	@Test(timeout = 3000)
	public void testFireTruckRespondtoSafeResidentialBuildingWithOtherThanFireDisasterException() throws Exception {
		CommandCenter cc = new CommandCenter();
		Simulator s = new Simulator(cc);
		...
		try {
			a.respond(b);
			fail("While there is no disaster on the building, " + CannotTreatException.class.getSimpleName()
					+ " should be thrown");
		} catch (CannotTreatException e) {

		} catch (Exception e) {
			fail("While there is no disaster on the building, " + CannotTreatException.class.getSimpleName()
					+ " should be thrown instead of " + e.getClass().getSimpleName());
		}
		...
		try {
			...
			fail("When FireTruck tries to treat a building while there is a Collapse Disaster on the building, "
					+ CannotTreatException.class.getSimpleName() + " should be thrown");
		} catch (CannotTreatException e) {

		} catch (Exception e) {
			fail("When FireTruck tries to treat a building while there is a Collapse Disaster on the building, "
					+ CannotTreatException.class.getSimpleName() + " should be thrown instead of \""
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testFireTruckRespondtoSafeResidentialBuildingWithException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address fireTruckAddress = getAddressFromWorld(s, 3, 9);
		Address buildingAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000)
	public void testFireTruckRespondtoCorrectResidentialBuildingExceptionNotThrown() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address fireTruckAddress = getAddressFromWorld(s, 3, 9);
		Address buildingAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testGasControlUnitRespondtoSafeResidentialBuildingException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		...
		ResidentialBuilding b = new ResidentialBuilding(buildingAddress);
		b.setEmergencyService(cc);
		GasControlUnit a = new GasControlUnit("GasControlUnit1", gasControlUnitAddress, 4, s);
		a.respond(b);
	}
	...
	@Test(timeout = 3000)
	public void testGasControlUnitRespondtoCorrectResidentialBuildingExceptionNotThrown() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address gasControlUnitAddress = getAddressFromWorld(s, 3, 9);
		Address buildingAddress = getAddressFromWorld(s, 3, 4);
	...
	@Test(timeout = 3000, expected = CannotTreatException.class)
	public void testEvacuatorRespondtoSafeResidentialBuildingException() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
	...
	@Test(timeout = 3000)
	public void testEvacuatorRespondtoCorrectResidentialBuildingExceptionNotThrown() throws Exception {
		Simulator s = new Simulator(sos);
		CommandCenter cc = new CommandCenter();
		Address evacuatorAddress = getAddressFromWorld(s, 3, 9);
		Address buildingAddress = getAddressFromWorld(s, 3, 4);
	...
	public void testStrikeInjuryNotThrown() throws Exception {
		...
		try {
			...
			fail("Exception \"" + e.getClass().getSimpleName()
	...
	private static Address getAddressFromWorld(Simulator s, int x, int y)
		...
		while (f == null) {
			if (curr == Object.class)
				fail("Class " + s.getClass().getSimpleName() + " should have the instance variable \"" + "world"
						+ "\".");
			try {
	...
	private void testClassIsSubclass(Class subClass, Class superClass) {
		assertTrue(subClass.getSimpleName() + " class should be a subclass from " + superClass.getSimpleName() + ".",
